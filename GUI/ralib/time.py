...
def to_date(date) -> str:
    ...
    """
    # some entry may be str '-' which is transformed from nan value, or datetime.time type
    # which is invalid. Ignore and keep it as str '-'
...
def same_month(this_date: str, that_date: str) -> bool:
    ...
    """
    # convert str obj to date obj, and if is '-', ignore
